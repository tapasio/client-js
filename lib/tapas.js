...
/***/ function(module, exports, __webpack_require__) {
	...
	var _QueryBatch = __webpack_require__(80);
	...
	function Tapas() {
	  ...
	  this.queryBatch = new _QueryBatch2.default(this.cacheManager);
	}
	
	Tapas.prototype.need = function (need) {
	  return new _Query2.default(need, this.queryBatch);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Cache() {
	  ...
	  this.cache = { user: user, home: home };
	}
	
	Cache.prototype.compareToCache = function (query) {
	  var entryPoint = (0, _keys2.default)(query)[0];
	
	  if (query[entryPoint].id) {
	    var id = query[entryPoint].id;
	...
	function compareToCacheWithId(query, cache) {
	  ...
	  var _compareToCache = compareToCache(query, cache.attrs);
	
	  var cached = _compareToCache.cached;
	  var missing = _compareToCache.missing;
	...
	function compareToCache(query, cache) {
	  ...
	  (0, _keys2.default)(query).forEach(function (attribute) {
	    if (cache[attribute]) {
	      if ((0, _typeof3.default)(cache[attribute]) === 'object') {
	        var nested = compareToCache(query[attribute], cache[attribute]);
	
	        if (nested.cached) {
	          cached[attribute] = (0, _extends3.default)({}, nested.cached);
	        }
	        if (nested.missing) {
	          missing[attribute] = (0, _extends3.default)({}, nested.missing);
	        }
	      } else {
	  ...
	  if (!(0, _keys2.default)(cached).length) {
	    cached = null;
	  }
	
	  if (!(0, _keys2.default)(missing).length) {
	    missing = null;
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _of = __webpack_require__(81);
	...
	QueryBatch.prototype.execute = function (need) {
	  var _cacheManager$compare = this.cacheManager.compareToCache(need);
	
	  var cached = _cacheManager$compare.cached;
	  var missing = _cacheManager$compare.missing;
	
	
	  if (cached && !missing) {
	    return (0, _of.of)(cached);
	  }
	
	  this.batch.push(missing);
	};
	
	exports.default = QueryBatch;
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Subscriber_1 = __webpack_require__(86);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var errorObject_1 = __webpack_require__(92);
