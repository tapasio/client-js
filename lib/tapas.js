...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TapasQuery = __webpack_require__(1);
	
	var _TapasQuery2 = _interopRequireDefault(_TapasQuery);
	...
	Tapas.prototype.need = function (need) {
	  return new _TapasQuery2.default(this.cache, this.cache, need);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Observable = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"rxjs/Observable\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	function TapasQuery(batch, cache, need) {
	  this.cache = cache;
	  this.batch = (0, _deepmerge2.default)(batch, need);
	}
	
	TapasQuery.prototype.execute = function () {
	  var request = deepDiffAttributes(this.batch, this.cache);
	...
	function deepDiffAttributes(batch, cache) {
	  ...
	  (0, _keys2.default)(batch).forEach(function (attribute) {
	    if (cache[attribute]) {
	      if ((0, _typeof3.default)(cache[attribute]) === 'object') {
	        var nestedAttributes = deepDiffAttributes(batch[attribute], cache[attribute]);
	        if ((0, _keys2.default)(nestedAttributes).length > 0) {
	          result[attribute] = (0, _assign2.default)({}, nestedAttributes);
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(33)(IteratorPrototype, __webpack_require__(64)('iterator'), function(){ return this; });
