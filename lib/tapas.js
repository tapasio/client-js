...
/***/ function(module, exports, __webpack_require__) {
	...
	Tapas.prototype.need = function (need) {
	  var tapasQuery = new _TapasQuery2.default(this.cache, need, this.execute);
	...
	Tapas.prototype.execute = function (tapasQueries) {
	  ...
	  this.tapasQueries.forEach(function (tapasQuery) {
	    if (batch[tapasQuery.getEntryPoint()]) {
	      batch[tapasQuery.getEntryPoint()] = (0, _deepmerge2.default)(batch[tapasQuery.getEntryPoint()], tapasQuery.getQuery());
	    } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	TapasQuery.prototype.getEntryPoint = function () {
	  return (0, _keys2.default)(this.need)[0];
	};
